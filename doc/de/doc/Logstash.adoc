...
Hinzugekommen sind die Felder `host`, `@timestamp` und `@version`.

.Weiterführende Informationen
* link:https://github.com/elastic/logstash/issues/3866['elastic/logstash Issue#3866', window="_blank"]
* link:https://www.elastic.co/de/blog/little-logstash-lessons-part-using-grok-mutate-type-data[Kurze Logstash-Lektionen – Teil 1: Datentypen festlegen mit Grok und Mutate, window="_blank"]
