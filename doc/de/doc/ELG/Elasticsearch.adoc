...
ifeval::["{{gitbook.version}}" == "3.2.2"]
image::diagram/elasticsearch-ntpstats-ng.png[elasticsearch-ntpstats-ng, link="https://raw.githubusercontent.com/wols/ntpstats-ng/master/doc/images/diagram/elasticsearch-ntpstats-ng.png"]
endif::[]
